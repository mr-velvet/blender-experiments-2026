...
FACES=[
    ...
    ["+Y_frente",( 0, 1, 0),   ( 0, 1.001, 0),   (math.radians(-90),0,math.radians(180)), 15, 0.52, 1.00,  0],
    ["-Y_tras",  ( 0,-1, 0),   ( 0,-1.001, 0),   (math.radians( 90),0,0),                 16, 0.50, 1.00,  0],
    ["+X_dir",   ( 1, 0, 0),   ( 1.001,0, 0),    (math.radians(90),0,math.radians(90)),   17, 0.50, 1.00,  0],
    ["-X_esq",   (-1, 0, 0),   (-1.001,0, 0),    (math.radians(90),0,math.radians(-90)),  18, 0.50, 1.00,  0],
    ["+Z_topo",  ( 0, 0, 1),   ( 0,0, 1.001),    (0,0,0),                                 15, 0.52, 1.40,  0],  # strength alto = relevo forte
    ["-Z_base",  ( 0, 0,-1),   ( 0,0,-1.001),    (math.radians(180),0,0),                 15, 0.52, 0.55,  0],  # strength baixo = relevo sutil
]
