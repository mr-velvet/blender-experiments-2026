...
Abre asm_a2.blend, shading SOLID com sombra+cavity (matcap-like), tira
...
BLEND=os.path.join(OUT,"asm_a2.blend")
def gv():
...
def tick():
    ...
    for nm,(eul,dist) in views.items():
        ...
        sc.render.filepath=os.path.join(OUT,f"asm_a2_viewport_{nm}.png")
